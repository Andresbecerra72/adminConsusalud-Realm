...
@Component({
  selector: 'app-ejecutadas-ordenes',
  templateUrl: './ejecutadas-ordenes.component.html',
  styles: [
  ]
})
export class EjecutadasOrdenesComponent implements OnInit {
  ...
  this.cargarOrdenes();
    ...
    cargarOrdenes() {
     ...
     this.ordenService.obtenerOrdenesConsulta( this.pagina, 'ejecutadas')
                        .subscribe((resp: any) => {
